...
import { Helpers, stringExtension } from "../utils/helpers.js";
...
let multerStorage = multer.diskStorage({
  ...
  filename: (req, file, cb) => {
    let filename = variables.DIR_UPLOADS + "/" + Helpers.generateKey(
...
const multerFileFilter = (req, file, cb) => {
  ...
  if (!Helpers.acceptFileExtension(file, filetypes)) {
    acceptUpload = false;
